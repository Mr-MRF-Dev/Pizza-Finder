...
int main() {
    ...
    while (1) {
        ...
        cout << " 7) List-Brs : list of the branches of a main pizza shop"
             << endl;
        cout << " 8) Near-P : nearst pizza shop to a location" << endl;
        cout << " 9) Near-Br : nearst selected pizza shop in a location"
             << endl;
        cout << "10) Avail-P : list of pizza shops in an area" << endl;
        cout << "11) Most-Brs : the main pizza shop with the most branches"
             << endl;
